class ReOrder{
    ...
    getPoint = function( e )
    {
        var scrollX = Math.max( 0, this._w.pageXOffset || this._d.scrollLeft || this._b.scrollLeft || 0 ) - ( this._d.clientLeft || 0 ), 
    ...
    _makeDragItem( item )
    {
        ...
        this._clickItem.classList.add('active');
    ...
    _trashDragItem()
    {
        ...
        {
            this._clickItem.classList.remove('active');
            this._clickItem = null;           
